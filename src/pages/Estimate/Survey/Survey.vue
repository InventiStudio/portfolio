<template lang="pug">
  section.survey
    form
      ...
      .row.align-center.mb-40.medium-mb-80
        .column.small-12.large-9
          .row.text-center
            .column.small-12.medium-4
              input.survey__input(type="radio", v-model="q1", id="q1a1", name="q1", value="a1")
              label.survey__label.o-card.mb-24(for="q1a1")
                .row.align-middle
        ...
        .column.small-12.large-9
          .row.text-center
            .column.small-12.medium-4
              ...
              label.survey__label.o-card.mb-24(for="q2a1")
                .row.align-middle
                  .column.small-4.medium-12.medium-mb-24
        ...
        .column.small-12.large-9
          .row.text-center
            .column.small-12.medium-4
              ...
              label.survey__label.o-card.mb-24(for="q3a1")
                .row.align-middle
                  .column.small-4.medium-12.medium-mb-24
                    icon.survey__icon(type="icon--monitor")
                  .column.small-8.medium-12.text-left.medium-text-center
